...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr12', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('princ_id');
            $table->uuid('hier12_id');
            $table->uuid('disc_id');
            ...
            $table->foreign('hier12_id')->references('id')->on('prostehier12')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr12');
    }
};

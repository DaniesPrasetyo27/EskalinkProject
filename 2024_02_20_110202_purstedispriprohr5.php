...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr5', function (Blueprint $table) {
            ...
            $table->foreign('hier5_id')->references('id')->on('prostehier5')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr5');
    }
};

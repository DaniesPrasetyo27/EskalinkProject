...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr2', function (Blueprint $table) {
            ...
            $table->foreign('hier2_id')->references('id')->on('prostehier2')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr2');
    }
};

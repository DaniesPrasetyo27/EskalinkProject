...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr8', function (Blueprint $table) {
            ...
            $table->foreign('hier8_id')->references('id')->on('prostehier8')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr8');
    }
};

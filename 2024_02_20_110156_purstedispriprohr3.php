...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr3', function (Blueprint $table) {
            ...
            $table->foreign('hier3_id')->references('id')->on('prostehier3')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr3');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('purstedispriprohr1', function (Blueprint $table) {
            ...
            $table->foreign('hier1_id')->references('id')->on('prostehier1')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr1');
    }
};

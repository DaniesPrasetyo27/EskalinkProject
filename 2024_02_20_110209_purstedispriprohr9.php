...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr9', function (Blueprint $table) {
            ...
            $table->foreign('hier9_id')->references('id')->on('prostehier9')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr9');
    }
};

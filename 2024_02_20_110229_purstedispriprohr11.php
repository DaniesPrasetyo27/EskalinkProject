...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr11', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('princ_id');
            $table->uuid('hier11_id');
            $table->uuid('disc_id');
            ...
            $table->foreign('hier11_id')->references('id')->on('prostehier11')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr11');
    }
};

...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr6', function (Blueprint $table) {
...
$table->float('def_disc_pct',20.4)->default('0');
            ...
            $table->foreign('hier6_id')->references('id')->on('prostehier6')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr6');
    }
};

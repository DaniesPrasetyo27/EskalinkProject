...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr10', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('princ_id');
            $table->uuid('hier10_id');
            $table->uuid('disc_id');
            ...
            $table->foreign('hier10_id')->references('id')->on('prostehier10')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr10');
    }
};

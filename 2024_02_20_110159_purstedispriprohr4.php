...
return new class extends Migration
{
 /**
    ...
    {
        Schema::create('purstedispriprohr4', function (Blueprint $table) {
            ...
            $table->foreign('hier4_id')->references('id')->on('prostehier4')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('purstedispriprohr4');
    }
};
